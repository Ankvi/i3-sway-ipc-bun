...
export type ContainerType = "root" | "workspace" | "output" | "con" | "floating_con" | "dockarea";
...
export type BaseContainer<T extends ContainerTypes> = NodeTypesForContainerTypes[T] & {
	id: number;
	type: T;
	orientation: string;
...
export type FloatingContent = BaseContainer<ContainerTypes.FloatingContent> & ContentProperties;

export const isContent = (x: Container): x is Content | FloatingContent =>
	x.type === ContainerTypes.Content || x.type === ContainerTypes.FloatingContent;
